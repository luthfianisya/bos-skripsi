...
const StepPeserta = ({
  ...
  setSp2dTanggal,
  disabled,
  readOnly = false, // ← tambahan default false
}: {
  ...
  disabled: boolean;
  readOnly?: boolean; // ← tambahkan ke props
}) => {
  const badgeText = {
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="flex flex-1 gap-6">
            <div className="flex flex-1 items-center gap-2">
              ...
              <Input value={sppNomor} onChange={(e) => setSppNomor(e.target.value)}   disabled={readOnly || disabled}/>

            </div>
            <div className="flex flex-1 items-center gap-2">
              <Label className="w-14">Tanggal</Label>
              <Input type="date" value={sppTanggal} onChange={(e) => setSppTanggal(e.target.value)}   disabled={readOnly || disabled} />
            </div>
          </div>
        </div>
