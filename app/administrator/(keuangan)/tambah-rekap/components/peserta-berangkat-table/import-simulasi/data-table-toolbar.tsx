"use client";
import { X, Plus, PlusCircleIcon, PrinterIcon, Trash2Icon } from "lucide-react";
...
export function DataTableToolbar({ table }: DataTableToolbarProps) {
  ...
  const paguSisaColumn = table.getColumn("paguSisa");
...
>
  Refresh
        ...
        <div className="flex items-center gap-2 max-w-sm w-full">
          <Input
            placeholder="Cari data simulasi perjalanan..."
            value={globalFilter || ""}
